...
export const articles: Article[] = [
  {
    id: 2171554,
    url: 'https://www.lemonde.fr/archives/article/1952/11/24/le-general-de-gaulle-doit-il-entrer-a-l-assemblee-nationale_2000698_1819218.html',
    publicationYear: 1952,
    nodes: [
      {
        type: 'title',
        content: 'Le général de Gaulle doit-il entrer à l’Assemblée nationale ?',
      },
      {
        type: 'paragraph',
        content: "Le général de Gaulle n'a pas accepté d'être candidat à l'élection législative partielle de Paris malgré l'insistance de la fédération de la Seine et de nombreux membres du Rassemblement. D'autres auraient aimé qu'il se présentât au scrutin de ballottage de Lille, sa ville natale, le premier tour leur donnant à penser qu'il aurait été élu; il est en effet vraisemblable que les autres candidats « non marxistes » se seraient retirés devant lui.",
      },
      {
        type: 'paragraph',
        content: "De ce que le général de Gaulle ne participera pas à la campagne électorale du premier secteur on ne saurait conclure ni que ce soit son état de santé qui l'en empêche ni que son état d'esprit ait changé; moins encore qu'il soit près de se retirer de la vie politique pour la seule raison qu'il n'y entre pas plus directement. Les propos contraires qui ont pu être prêtés par M. Pierre de Gaulle ont été formellement démentis par lui ce matin. Le général n'a d'ailleurs pas davantage pris part à la campagne électorale qui a eu lieu, l'été dernier dans le deuxième secteur de Paris.",
      },
      {
        type: 'paragraph',
        content: "Mais les invites qui lui sont régulièrement adressées et ses refus réitérés prouvent cependant que la question de sa présence à l'Assemblée nationale ne cesse de se poser non seulement aux militants gaullistes, mais aux compagnons les plus intimes de leur chef.",
      },
      {
        type: 'paragraph',
        content: "Au regard de beaucoup de dirigeants et de députés R.P.F., le pour l'emporte aujourd'hui sur le contre. Entrant à l'Assemblée nationale, le général de Gaulle prouverait qu'il ne veut pas se borner à condamner le régime du dehors, mais entend le réformer du dedans. Il ruinerait les attaques de ceux qui lui reprochent de le critiquer d'une manière stérile et systématique."
      }
    ]
  },
  {
    ...
    nodes: [
      ...
      {
        type: 'heading',
        content: 'Le chanteur est mort, jeudi à Los Angeles, à l’âge de 50 ans. Les causes exactes et le rôle des médicaments dans son décès restent flous. Auteur, compositeur, danseur, Michael Jackson se préparait à un retour sur scène.',
      },
      {
        type: 'paragraph',
        content: "Le chanteur américain Michael Jackson, 50 ans, est mort, jeudi 25 juin, après avoir été hospitalisé en urgence dans un hôpital de Los Angeles. \"M. Jackson a été transporté à l'hôpital (...), il était inconscient lorsqu'il a été admis et son décès a été constaté à 14 h 26 (23 h 26 à Paris) cet après-midi\", a déclaré un porte-parole de l'institut médico-légal du comté de Los Angeles, le lieutenant Fred Corral. Selon le Los Angeles Times et le site Internet TMZ.com, qui a le premier donné la nouvelle, Jackson a été victime d'un arrêt cardiaque à son domicile de Holmby Hills, un quartier opulent du nord-ouest de la ville où il louait un manoir depuis janvier.",
      },
      {
        type: 'paragraph',
        content: "Le lieutenant Corral s'est refusé à toute précision sur les causes du décès, expliquant qu'une autopsie serait pratiquée, sans doute dès vendredi, pour les déterminer. Les autorités ont prévenu qu'il faudrait sans doute plusieurs semaines avant de déterminer la cause exacte du décès, dans l'attente de résultats d'examens toxicologiques."
      },
      {
        type: 'paragraph',
