...
export const articles: Article[] = [
  ...
  {
    id: 232119,
    url: 'https://www.lemonde.fr/disparitions/article/2018/01/07/la-chanteuse-france-gall-est-morte_5238465_3382.html',
    publicationYear: 2018,
    publicationDate: '7 janvier 2018',
    personality: 'France Gall',
    nodes: [
      {
        type: 'publication',
        content: 'Publié le 07 janvier 2018',
      },
      {
        type: 'title',
        content: 'La chanteuse France Gall est morte',
      },
      {
        type: 'heading',
        content:
      ...
      {
        type: 'paragraph',
        content: 'La chanteuse France Gall est morte, dimanche 7 janvier, à Paris, a annoncé sa chargée de communication, Geneviève Salama : « Il y a des mots qu’on ne voudrait jamais prononcer. France Gall a rejoint le Paradis blanc le 7 janvier, après avoir défié depuis deux ans, avec discrétion et dignité, la récidive de son cancer. » L’interprète de Poupée de cire, poupée de son et de Résiste avait été hospitalisée mi-décembre à l’Hôpital américain de Neuilly, près de Paris, officiellement pour une infection sévère.',
      },
      {
        type: 'subtitle',
        content: 'Une famille de musiciens',
      },
      {
        type: 'paragraph',
        content: 'Isabelle Gall, de son vrai nom, est née le 9 octobre 1947 à Paris. Elle grandit dans l’univers de la musique. Son père, Robert Gall, lui-même chanteur et auteur, avait composé des chansons pour Edith Piaf et Charles Aznavour ; son grand-père avait, lui, cofondé les Petits Chanteurs à la Croix de bois.',
      },
      {
        type: 'paragraph',
        content: 'Commençant à chanter dès l’adolescence, elle monte sur scène dès l’âge de 16 ans et connaît son premier succès populaire avec Sacré Charlemagne, écrit par son père, qui se vend à plus de deux millions d’exemplaires.',
      },
      {
        type: 'subtitle',
        content: 'Gagnante de l’Eurovision',
      },
      {
        type: 'paragraph',
        content: 'En 1965, France Gall remporte le concours Eurovision de la chanson, pour le Luxembourg, en interprétant Poupée de cire, poupée de son, de Serge Gainsbourg. Elle suscitera le scandale en chantant un autre tube écrit par l’auteur-compositeur, Les Sucettes, aux paroles suggestives.',
      },
      {
        type: 'paragraph',
        content: 'A la fin des années 1960, elle enchaîne les disques et part chanter en Allemagne, mais sans renouer avec le succès populaire de ses débuts. Elle entretient une brève liaison avec Claude François auquel leur rupture inspirera Comme d’habitude. Après Bébé Requin (1967), sa carrière piétine. France Gall vit cinq ans avec Julien Clerc, puis le quitte. Il chantera Souffrir par toi n’est pas souffrir.',
      },
      {
        type: 'subtitle',
        content: 'La rencontre avec Michel Berger',
      },
      {
        type: 'paragraph',
        content: 'Sa rencontre avec Michel Berger en 1973 constitue le tournant de sa carrière. Il écrit pour elle La Déclaration d’amour en 1974, un single qui relance durablement sa carrière. France Gall devient sa muse mais aussi son épouse et la mère de ses deux enfants, Pauline en 1978 et Raphaël en 1981.',
      },
      {
        type: 'paragraph',
  ...
  },
  {
    ...
    nodes: [
      ...
      {
        type: 'paragraph',
        content: 'L’espoir que cette avancée rock mène Bowie à la reconnaissance doit à nouveau faire face à la réalité. Le chanteur et son groupe commencent certes à attirer les regards et les oreilles, mais ils ne sont pas encore en pleine lumière, comme espéré. De ce point de vue-là, c’est plutôt Marc Bolan qui a pris de l’avance. Visconti a travaillé avec lui, Bowie en sera mécontent quelque temps.',
      },
      {
        type: 'paragraph',
        content: 'Le disque suivant, Hunky Dory, en décembre 1971, avec la chanson Life on Mars, marque un retour provisoire vers une manière plus folk et apaisée. Avec Bowie, outre Mick Ronson, on y entend le bassiste Trevor Bolder (1950-2013) et le batteur Mick Woodmansey, soit les Spiders from Mars. Le claviériste Rick Wakeman, futur musicien du groupe Yes, participe aussi aux séances.',
      },
      {
        type: 'subtitle',
        content: 'La révélation Ziggy Stardust',
      },
      {
        type: 'paragraph',
        content: 'Mais la révélation au grand public et le début, en Grande-Bretagne d’abord, d’une « Bowiemania », qui prendra le pas sur la « T.Rexmania », se feront quelques mois plus tard avec le personnage de Ziggy Stardust. Un nouveau manager est arrivé, Tony DeFries, un homme d’affaires redoutable. S’il va certes accompagner l’essor de Bowie, DeFries va concocter des contrats pas toujours à l’avantage du chanteur, dont il mettra par la suite plusieurs années à se défaire.',
      },
      {
        type: 'paragraph',
  ...
  },
  {
    ...
    nodes: [
      ...
      {
        type: 'paragraph',
        content: 'L’état de santé de l’écrivain, qui était âgé de quatre-vingt-cinq ans, s’était aggravé depuis deux mois et faisait l’objet d’une surveillance médicale constante. M. François Mitterrand a fait en fin de matinée la déclaration suivante : "La France est endeuillée par la disparition de l’un de ses plus grands écrivains. Louis Aragon faisait partie du siècle dont il aura vécu jusqu’au bout les douleurs et les espoirs. La magie de sa poésie et la force de son œuvre le mettent au premier rang de notre littérature nationale. Je m’incline devant sa mémoire." M. Georges Marchais, secrétaire général du parti communiste, s’est rendu vendredi matin au domicile de l’écrivain, ainsi que MM. Fiterman et Hermier.',
      },
      {
        type: 'paragraph',
        content: 'Il y a des morts inattendues qui nous cueillent comme la foudre - Camus, Montherlant, Gary, - et d’autres, on dirait des dénouements. Voilà des années qu’Aragon divague, qu’il regarde son personnage en étranger ; "Comme un voisin de wagon-lit", disait-il. Voilà des années que le voisin de wagon-lit d’Aragon, donc, se relève la nuit, un stetson ivoire en bataille, et vas-y que je te galope dans Paris, au risque de bouler sous un camion comme un gibier ébloui. Autant dire que, côté nécrologies, pas un journal ne sera pris au dépourvu ! Mais, à trop prévoir le pire, l’émotion file. Or voici qu’elle nous submerge ! Ça y est : le peu de voix qui restait s’est tu. Le sale nuage du néant a passé sur l’œil trop bleu. La tête neigeuse ne se penchera plus, pour la confidence assassine ou contre le visage d’Elsa... Cela vaut bien que notre plume tremble.',
      },
      {
        type: 'paragraph',
        content: 'De deux choses l’une, quand meurt un tel homme. Ou l’on gomme ses silences, jugeant que ce n’est pas le moment. Ou bien, froidement, on dit : la mort n’est pas une excuse et on vide le linge sale avec le blanc. Les biographies qui vont suivre ne cachent rien des couleuvres avalées, c’est mieux ainsi. On va rappeler une dernière fois la docilité d’Aragon au parti communiste qui, en 1944, lui avait rendu "ses yeux et sa mémoire", et qui les lui a ravis ensuite. Les procès de Moscou ignorés à dessein, la condamnation en douce de Gide retour d’U.R.S.S., les crachats sur Nizan, la discrétion devant les coups de Budapest et de Varsovie, fallait le faire !... Comme avec Céline, qu’il est dur de séparer, si vite, le poète du politique !',
      },
      {
        type: 'paragraph',
        content: 'Et pourtant, il le faut ! "La fin d’un homme ressemble à la lueur première de la création", disait-il. Cette lueur, aucune œuvre du siècle n’en aura autant resplendi. "Moi, je griffe le papier, se plaignait son ami Drieu La Rochelle, Aragon, lui, ça court !" Pour courir, ça courait ! Depuis soixante ans, de l’explosion surréaliste à Théâtre-roman, en passant par les œuvres maîtresses - Aurélien, les Cloches de Bâle, la Semaine sainte, - la poésie résistante et amoureuse que la chanson a popularisée, quelle crue de mots flamboyants ! Quelles étendues noyées de prose et de poésie admirables ! L’électricité du surréalisme apprivoisée ! La langue française réinventée, devenue chanson, danse, coup de fouet !',
      },
      {
        type: 'paragraph',
        content: 'En même temps qu’il écrit, Aragon, comme les peintres de sa génération, dévoile sans cesse le "comment" de ce qu’il fait. L’artiste travaille à ciel ouvert, sans filet. Grâce à un langage "parlé" aussi concerté et musicalement agencé que l’étaient les points de suspension de Céline, à coups de "Voulez-vous me dire ?" et "Je vous demande un peu", il introduit le lecteur dans le mystère insondable de l’inspiration, cette volière où Cratyle imaginait qu’en attendant notre bon vouloir les mots roucoulent et battent de l’aile.',
      },
      {
        type: 'paragraph',
        content: 'Nos rêves brisés comme les coquilles dont est né le pétrole, nos souvenirs mangés par l’oubli comme un miroir dont le tain s’embue, nos paroles en l’air et nos serments chuchotes, le grand râle de toutes les agonies d’avant la nôtre, le bruit de nos destins cahotants, la joie menue, le vent du désespoir, Aragon en fait une houle reconnaissable à cent paragraphes, à l’égal de Hugo, comme lui élégiaque et épique, d’une fécondité suffocante, étincelante, princière.',
      },
      {
        type: 'paragraph',
        content: 'C’est à cette vague d’émotions et d’images, à ces morceaux grondants de littérature grandiose, grandiose parce que gagnée mot après mot sur l’épouvante de la mort partout présente, c’est à ce tour de force qu’il faut penser à cet instant. Le vingtième siècle français perd son plus grand poète ; il perd son fou.',
      },
    ],
  },
  {
